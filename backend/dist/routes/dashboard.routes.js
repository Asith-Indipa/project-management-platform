...
router.get("/project-manager", (0, role_middleware_1.roleMiddleware)("PROJECT_MANAGER"), dashboardController.getManagerStats);
router.get("/team-member", (0, role_middleware_1.roleMiddleware)("TEAM_MEMBER"), dashboardController.getTeamMemberStats);
